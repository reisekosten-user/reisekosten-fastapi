...
def get_migrations() -> list[str]:
    ...
    return [
        ...
        "ALTER TABLE mitarbeiter ADD COLUMN IF NOT EXISTS kreditkarten_auslandsentgelt_prozent NUMERIC(4,2) DEFAULT 1.5",
        ...
        "ALTER TABLE belege ADD COLUMN IF NOT EXISTS hotel_lat NUMERIC(9,6)",
        "ALTER TABLE belege ADD COLUMN IF NOT EXISTS hotel_lon NUMERIC(9,6)",
        ...
        "ALTER TABLE termine ADD COLUMN IF NOT EXISTS lat NUMERIC(9,6)",
        "ALTER TABLE termine ADD COLUMN IF NOT EXISTS lon NUMERIC(9,6)",
        "ALTER TABLE termine ADD COLUMN IF NOT EXISTS land_code TEXT",
