"""
mod_geo.py – Länder-Koordinaten (Zentroide) für die Dashboard-Weltkarte.
Quelle: komsitr/country-centroid (öffentliches Datenset, ISO 3166-1 Alpha-2).
"""
...
def koordinaten_fuer_land(land_code: str):
    """Gibt (lat, lon) für einen ISO-2-Ländercode zurück, oder None."""
    if not land_code:
        return None
